...
export const portfolioItems: IPORTFOLIO_ITEM[] = [
  {
    ...
    title: "Лендинг",
    description:
      "Продаж авто, франшиза, курсовий продаж, продаж дорожніх знаків, бухгалтерія",
  ...
  },
  {
    ...
    description:
      "Художні матеріали, доставка їжі, продаж сухого льоду, продаж їжі, туристичне агентство",

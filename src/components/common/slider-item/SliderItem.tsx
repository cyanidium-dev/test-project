import { SliderItemProps } from '@/types/components/carousel-item';
...
export default function SliderItem({
    ...
    return (
        <div className="relative w-[300px] h-[450px] rounded-xl p-[1px]" style={outerContainerStyle}>
            {review ? (
                <div className="w-full h-full flex flex-col rounded-xl overflow-hidden" style={reviewContainerStyle}>
